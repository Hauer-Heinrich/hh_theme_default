...
(function() {
    ...
    this.feLogin = function() {
        let defaults = {
            "requestUrl": '//www.{{EXTENSION_DOMAIN_NAME}}.hauer-heinrich.de/frontend-login',
    ...
    function checkSettings(element) {
        if(this.settings.requestUrl.startsWith('//www.{{EXTENSION_DOMAIN_NAME}}.hauer-heinrich.de')) {
